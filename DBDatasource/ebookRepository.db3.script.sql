...
CREATE TABLE [FILE_CHECKSUM_MD5] (
    ...
    [CHECKSUM] NVARCHAR (32)	CONSTRAINT [NN_FILE_CHECKSUM_MD5_CHECKSUM]     NOT NULL   ON CONFLICT ROLLBACK
);
...
CREATE TABLE [FILE_CHECKSUM_SHA1] (
    ...
    [CHECKSUM] NVARCHAR (40)	CONSTRAINT [NN_FILE_CHECKSUM_SHA1_CHECKSUM] NOT NULL       ON CONFLICT ROLLBACK
);
