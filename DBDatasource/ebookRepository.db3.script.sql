...
SELECT [F].[F_CODI], [F].[F_NAME], [F].[F_EXTE], [F].[F_SIZE], [F].[F_TIME],[MD5].[CHECKSUM_MD5] AS [MD5], [SHA1].[CHECKSUM_SHA1] AS [SHA1], [SHA256].[CHECKSUM_SHA256] AS [SHA256]  
FROM [FILE_DOC] AS [F]
...
SELECT [F].[F_CODI], [F].[F_NAME] || [F].[F_EXTE] AS [F_FILE], [F].[F_SIZE], [F].[F_TIME],[MD5].[CHECKSUM_MD5] AS [MD5], [SHA1].[CHECKSUM_SHA1] AS [SHA1], [SHA256].[CHECKSUM_SHA256] AS [SHA256]  
FROM [FILE_DOC] AS [F]
LEFT JOIN [FILE_CHECKSUM_MD5] AS [MD5]
ON [F].[F_CODI] = [MD5].[FILE_DOC_F_CODI]
LEFT JOIN [FILE_CHECKSUM_SHA1] AS [SHA1] 
